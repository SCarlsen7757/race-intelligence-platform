...
public sealed class PostgresFixture : IAsyncLifetime
{
    ...
    /// <summary>Creates a new <see cref="RaceIntelligenceDbContext"/> against the running container.</summary>
    public RaceIntelligenceDbContext CreateContext()
    {
        var options = new DbContextOptionsBuilder<RaceIntelligenceDbContext>()
            .UseNpgsql(ConnectionString)
            .Options;

        return new RaceIntelligenceDbContext(options);
    }
}
