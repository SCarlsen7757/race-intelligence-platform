...
/// ingest API in batches, flushing a batch once it reaches <see cref="CollectorOptions.MaxBatchSize"/>
/// samples <i>or</i> <see cref="CollectorOptions.MaxBatchAge"/> has elapsed since the batch's first
...
/// bound guarantees every batch uploads within <see cref="CollectorOptions.MaxBatchAge"/> of its
