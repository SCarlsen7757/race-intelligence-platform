...
namespace RaceIntelligence.Collector.Abstractions.Buffering;
...
public interface ITelemetryBuffer : IAsyncDisposable
{
    ...
    /// </remarks>
    bool TryWrite(RaceRoomTelemetrySample sample, CancellationToken cancellationToken = default);
    ...
    bool TryRead(out RaceRoomTelemetrySample sample);
