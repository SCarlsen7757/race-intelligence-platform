# Race Intelligence Platform (RIP)

> **Vision:**  
> Build a simulator-agnostic telemetry and race strategy platform that continuously improves through collected data. The platform is **data-driven first**, **machine learning second**, and **AI-assisted third**.
...
The RaceRoom shared-memory structs under
`src/RaceIntelligence.Connectors.RaceRoom/Interop/` are an independent C# port of the layout
published by [r3e-api](https://github.com/kwstudios-sweden/r3e-api); see those files for details.